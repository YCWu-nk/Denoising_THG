...
parser.add_argument("--noisetype", type=str, default="poisson30", choices=['poisson30', 'gauss5_50', 'poisson30', 'poisson5_50'])
parser.add_argument('--checkpoint', type=str, default='experiments/results/THG-2023-12/models/epoch_model_500.pth')
...
network = load_network(opt.checkpoint, network, strict=False)
beta = opt.beta
...
np.random.seed(101)
valid_repeat_times = {"data_THG": 1}  #modify
